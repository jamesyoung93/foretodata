...
const accomplishments = [
  ...
  },
  {
    ...
    summary: "Summer internship project building models to predict chemical properties of polymers using interpretable methods.",
    goals: ["accelerate-research", "improve-operations"],
    methods: ["interpretable-ml", "bayesian-optimization"],
    industries: ["national-lab"],
    details: "Built neural networks, Gaussian process regression, and interpretable ML models with Bayesian optimization for hyperparameter tuning. Achieved accuracy matching closed-source alternatives using open methods. Deployed via R Shiny.",
    metrics: ["Matched closed-source accuracy", "Open methods"],
  },
  {
    id: 7,
...
const goalCategories = {
  ...
  'productivity': { label: 'Productivity', icon: '>', description: 'Free time for higher-value work' },
  ...
  'reduce-risk': { label: 'Reduce Risk', icon: '>', description: 'Minimize business and operational risk' },
...
const methodCategories = {
  ...
  'mlops': { label: 'MLOps', icon: '>', description: 'Production ML systems and pipelines' },
