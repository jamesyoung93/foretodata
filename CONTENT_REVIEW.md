...
| Independent advisory positioning | Remove it as a public positioning pillar. | The homepage card and section, About section, footer link, and advisory content were removed. The prior URL redirects to Work. |
...
| Insights | Lead with current senior-level thinking while preserving useful inbound URLs. | Three 2026 Substack essays now lead `/writing`. Three earlier technical notes remain at `/writing/archive`; the former Foundations entries remain removed, and their prior URLs redirect to Insights. See `ARCHIVE_REVIEW.md` for the full 20-PDF audit. |
